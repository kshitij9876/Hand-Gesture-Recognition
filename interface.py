...
model1 = models.load_model('Models\Action_NPY_Hap_Bod.h5')
model2 = models.load_model('Models\Action_NPY_WATR_AER.h5')
model3 = models.load_model('Models\Action_NPY_I_YO.h5')
model4 = models.load_model('Models\Action_NPY_Wat_Wav.h5')
model5 = models.load_model('Models\Action_NPY_LI_GI.h5')
